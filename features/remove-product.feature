...
Scenario: Successfully remove products with at least 2 units from the cart
Given that there is at least 2 units of the same product in the cart
When I remove that product from the cart
Then the cart should not contain any products anymore

Scenario: Successfully remove at least 2 products from the cart
Given that there is at least 2 different products in the cart
When I remove all of the products from the cart
Then the cart should not contain any products anymore

Scenario: Successfully remove 1 of at least 2 different products from the cart
Given that there is at least 2 different products in the cart

...
When I press search button
Then I should be given a list of products that matches "Glentauchers"
And I should be given a list of products that matches "Chapter 7 Bourbon Barrel 18 Years"

...
And that I seach and added one products to the cart
...
Given that I am on the web page localhost:3000
And that I seach and added two different products to the cart
...
Given that I am on the web page localhost:3000
And that I seach and added products to the cart
